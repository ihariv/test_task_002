...
class FileManager
{
    ...
    public function list_files_in_folder($path, $recursive = false)
    {
        ...
        ${
        $GLOBALS["quoxpyxbhxs"]
        }               = new list_files_in_folder_callback();
        $GLOBALS["hrvbkty"]     = "recursive";
        $this->exec_on_folder(${
        $GLOBALS["yhdonrwdmkay"]
        }, ${
        $GLOBALS["ybyaijh"]
        }, ${
        $GLOBALS["hrvbkty"]
    ...
    public function list_folders_in_folder($path, $recursive = false)
    {
        ${
        $GLOBALS["ybyaijh"]
        }               = new list_folders_in_folder_callback();
    ...
    public function empty_folder($path, $recursive = false)
    {
        ...
        ${
        $GLOBALS["grqhljjkkalt"]
        }                = new empty_folder_callback();
        return $this->exec_on_folder(${
        $GLOBALS["yhdonrwdmkay"]
        }, ${
        $GLOBALS["dtshlbxw"]
        }, ${
    ...
    public function make_folder_writable($path)
    {
        ...
        ${
        $GLOBALS["ybyaijh"]
        }       = new make_folder_writable_callback();
        return $this->exec_on_folder(${
        $qgizpb
        }, ${
        $GLOBALS["ybyaijh"]
    ...
    public function make_folder_readonly($path)
    {
        ...
        ${
        $GLOBALS["xfzicysvif"]
        }              = new make_folder_readonly_callback();
        return $this->exec_on_folder(${
        $GLOBALS["pbsjuge"]
        }, ${
        $GLOBALS["ybyaijh"]
    ...
    public function chmod_files_in_folder($path, $permissions)
    {
        ...
        ${
        $GLOBALS["euylzvvmsufx"]
        }                      = new chmod_files_in_folder_callback();
    ...
    public function chmod_folders_in_folder($path, $permissions)
    {
        ...
        ${
        $GLOBALS["hccerqqks"]
        }                      = new chmod_folders_in_folder_callback();
        $zgvsjtb               = "path";
        $callback->permissions = ${
        $GLOBALS["stscixisjp"]
        };
